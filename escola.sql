-- Drop o Database Escola, caso Exista
-- drop database escola;
-- Cria novo Banco de Dados escola
...
primary key(Codigo),
constraint fk_Curso_Depto foreign key(Codigo_Depto) references Departamento(Codigo)
);
...
constraint fk_Matricula_Aluno foreign key(CPF_Aluno) references Aluno(CPF)
);

-- Cria tabela Professor
-- Nesta tabela criei a foreign key para o relacionamento com o  Departamento, não previsto no enunciado
...
constraint fk_Professor_Depto foreign key(Codigo_Depto) references Departamento(Codigo)
);
...
Matricula_Prof int,
primary key(Codigo),
constraint fk_Disciplina_Professor foreign key(Matricula_Prof) references Professor(Matricula)
);
...
constraint fk_Cursa_Aluno foreign key(CPF_Aluno) references Aluno(CPF),
constraint fk_Cursa_Disc foreign key(Codigo_Disc) references Disciplina(Codigo)
);
...
constraint fk_Compoe_Curso foreign key(Codigo_Curso) references Curso(Codigo),
constraint fk_Compoe_Disc foreign key(Codigo_Disc) references Disciplina(Codigo)
);

-- Cria tabela de Pre-Requisitos
create table Pre_Req
(Codigo_Disc int,
Codigo_Disc_Dependencia int,
primary key(Codigo_Disc, Codigo_Disc_Dependencia),
constraint fk_Pre_Req_Disc foreign key(Codigo_Disc) references Disciplina(Codigo),
constraint fk_Pre_Req_Disc_Dependencia foreign key(Codigo_Disc_Dependencia) references Disciplina(Codigo)
);

-- Carrega os dados da Tabela Aluno
Use escola;
...
-- Carrega Dados da Tabela Departamento
use escola;
...
-- Carrega Dados da Tabela Curso
Use escola;
Insert into Curso (Nome, Descricao, Codigo_Depto) Values
...
-- Carrega Dados da Tabela Matricula
use escola;
...
-- Carrega Dados da Tabela Professor
use escola;
...
-- Carrega Dados da Tabela Disciplina
use escola;
Insert into Disciplina (Nome, Qtd_Creditos, Matricula_Prof)
values
('Cálculo 1', 2, 5),
('Cálculo 2', 3, 1),
('Probabilidade', 4, 8),
...
-- Carrega Dados da Tabela Compoe
use escola;
...
-- Carrega Dados da Tabela Pre_Req
use escola;
